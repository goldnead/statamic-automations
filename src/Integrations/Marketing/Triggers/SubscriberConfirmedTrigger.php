...
class SubscriberConfirmedTrigger implements AutomationTrigger
{
    ...
    {
        return 'Triggered when someone (double-)opts in to a marketing mailing list.';
    }
